...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/24 01:02:44 by mgrissen          #+#    #+#             */
/*   Updated: 2021/11/24 03:46:22 by yhebbat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin_dollar(char *s1, char *s2, int i)
{
	...
	while (s2[ss2] != '\0')
		ss2++;
	new = (char *)malloc((i + ss2 + 1) * sizeof(char));
	if (!new)
		return (0);
	ft_memmove(new, s1, i);
...
char	*ft_strjoin(char *s1, char *s2)
{
	...
	while (s2[ss2] != '\0')
		ss2++;
	new = (char *)malloc((ss1 + ss2 + 1) * sizeof(char));
	if (!new)
		return (0);
